...
<div id="templatemo_content_wrapper">
  ...
  <tr>
	 ...
	 <table align="center" width="400" style="border:1px solid green;" bgcolor="#FFFFFF">
		<form name="f" action="CSPlog.jsp" method="post" onSubmit="return valid();">
		<tr>
		<td height="36" colspan="2" align="center" bgcolor="#979700" class="paragraping2">
                    <span style="color:#FFFFFF"><strong>Cloud Service Provider Login</strong><strong></strong></span></td>
		</tr>
		<tr>
