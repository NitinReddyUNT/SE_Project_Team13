<!--This page is used to display all the data owners in a tabular format -->
  ...
  <div id="templatemo_header">
    <div id="templatemo_menu">
            ...
            <ul>
                 ...
                 <li><a href="TA_viewOwners.jsp"  class="current">View Owners</a></li>
...
<!--To display table with all owners and a generate link which generates membership key to the owners-->
	<table width="1000" border="0">
  <tr>
      <td align="center">
         
          <h2>VIEW ALL DATA OWNERS AND GENERATE MEMBERSHIP  KEY</h2>
      </td>
  </tr>
        </table>
        <center>
        <table border="1">
            ...
            <!-- To retrieve all the owner details from database -->
           <%try{
               ResultSet r=Queries.getExecuteQuery("select * from owner");
               while(r.next()){
                 String mskey=r.getString("mkey");  
                 %>
                 <tr>
                     ...
                     <td><a href="GenerateMSKey.jsp?id=<%=r.getString("id")%>">Generate</a></td>
                     <%}else{%>
                      <td><%=mskey%></td>
                     <%}%>
                 </tr>
