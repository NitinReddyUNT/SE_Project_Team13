...
<div id="templatemo_header_wrapper">
  <div id="templatemo_header">
    <div id="templatemo_menu">
      		<div id="templatemo_menu_left"></div>  <!-- list of all the elements-->
            <ul>
                 ...
                 <li><a href="CSP_ViewRequest.jsp">View Requests</a></li>
                  ...
                  <li><a href="CSP_ReENCTimeGrpah.jsp"  class="current">Re_Encryption Time Graph</a></li>
...
<div id="templatemo_content_wrapper">
  ...
  <tr>
	 ...
	 <td>
            ...
            <iframe src="REEncTimeGraph" width="1000" height="400"></iframe>
</table>
