...
<!--This page is used to allow owner to register owner module by giving their details-->
...
<!--  The below block is used to display other tabs so that owner can navigate  -->
...
<!--this block is used to display title of project-->
...
<div id="templatemo_content_wrapper">
  ...
  <tr>
      <!--To ask for owner details like user name,dob,password for registration-->
	 ...
	 <table align="center" width="400"  height="500" style="border:1px solid green;" bgcolor="#FFFFFF">
		<form name="f" action="OwnerReg.jsp" method="post" onSubmit="return valid();">
		<tr>
		<td height="36" colspan="2" align="center" bgcolor="#979700" class="paragraping2">
                    <span style="color:#FFFFFF"><strong>Owner Register Here</strong><strong></strong></span></td>
		</tr>
		<tr>
		...
		<!--to display hyperlink to login page so that owner can login if he already have an account-->
		<tr>
                    <tr>
		<td height="47" class="paragraping">Already Have An Account</td>
                <td><a href='DataOwner.jsp'>Login</a></td>
		</tr>
